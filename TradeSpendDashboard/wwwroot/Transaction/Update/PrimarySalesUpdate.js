...
var optionYearsStore = new DevExpress.data.CustomStore({
    ...
    load: function (loadOptions) {
        ...
        var loadUrl = baseUrl + "Parameter/GetYearsPrimarySalesOption?transaction=Update";
        return loadData(loadUrl, loadOptions);
    },
    byKey: function (key) {
        var d = new $.Deferred();
        $.get(baseUrl + "Parameter/GetYearsPrimarySalesOption?key=" + key + "&transaction=Update")
            .done(function (dataItem) {
...
function InitTablePrimarySales() {
    ...
    dataGrid = $("#gridContainer").dxDataGrid({
        ...
        onExporting: function (e) {
            ...
            var worksheet = workbook.addWorksheet('Primary Sales Update');
            DevExpress.excelExporter.exportDataGrid({
                ...
                workbook.xlsx.writeBuffer().then(function (buffer) {
                    saveAs(new Blob([buffer], { type: 'application/octet-stream' }), 'Export Primary Sales Update.xlsx');
                });
            });
            e.cancel = true;
        },
...
function openModalUpload(flag) {
    $('#inpFlag').val(flag);
    $('#titleModalUpload').text('Primary Sales Update');
