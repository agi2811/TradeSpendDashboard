...
var optionYearsStore = new DevExpress.data.CustomStore({
    ...
    load: function (loadOptions) {
        ...
        var loadUrl = baseUrl + "Parameter/GetYearsSpendingPhasingOption?transaction=Upload";
        return loadData(loadUrl, loadOptions);
    },
    byKey: function (key) {
        var d = new $.Deferred();
        $.get(baseUrl + "Parameter/GetYearsSpendingPhasingOption?key=" + key + "&transaction=Upload")
            .done(function (dataItem) {
...
function InitTableSpendingPhasing() {
    ...
    dataGrid = $("#gridContainer").dxDataGrid({
        ...
        onExporting: function (e) {
            ...
            var worksheet = workbook.addWorksheet('Spending Phasing Upload');
            DevExpress.excelExporter.exportDataGrid({
                ...
                workbook.xlsx.writeBuffer().then(function (buffer) {
                    saveAs(new Blob([buffer], { type: 'application/octet-stream' }), 'Export Spending Phasing Upload.xlsx');
                });
            });
            e.cancel = true;
        },
...
function openModalUpload(flag) {
    $('#inpFlag').val(flag);
    $('#titleModalUpload').text('Spending Phasing Upload');
