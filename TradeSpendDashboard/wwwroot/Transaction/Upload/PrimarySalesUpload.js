...
var optionYearsStore = new DevExpress.data.CustomStore({
    ...
    load: function (loadOptions) {
        ...
        var loadUrl = baseUrl + "Parameter/GetYearsPrimarySalesOption?transaction=Upload";
        return loadData(loadUrl, loadOptions);
    },
    byKey: function (key) {
        var d = new $.Deferred();
        $.get(baseUrl + "Parameter/GetYearsPrimarySalesOption?key=" + key + "&transaction=Upload")
            .done(function (dataItem) {
...
function InitTablePrimarySales() {
    ...
    dataGrid = $("#gridContainer").dxDataGrid({
        ...
        onExporting: function (e) {
            ...
            var worksheet = workbook.addWorksheet('Primary Sales Upload');
            DevExpress.excelExporter.exportDataGrid({
                ...
                workbook.xlsx.writeBuffer().then(function (buffer) {
                    saveAs(new Blob([buffer], { type: 'application/octet-stream' }), 'Export Primary Sales Upload.xlsx');
                });
            });
            e.cancel = true;
        },
...
function openModalUpload(flag) {
    $('#inpFlag').val(flag);
    $('#titleModalUpload').text('Primary Sales Upload');
