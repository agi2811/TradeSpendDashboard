...
var optionYearsStore = new DevExpress.data.CustomStore({
    ...
    load: function (loadOptions) {
        ...
        var loadUrl = baseUrl + "Parameter/GetYearsSecondarySalesOption?transaction=Actual";
        return loadData(loadUrl, loadOptions);
    },
    byKey: function (key) {
        var d = new $.Deferred();
        $.get(baseUrl + "Parameter/GetYearsSecondarySalesOption?key=" + key + "&transaction=Actual")
            .done(function (dataItem) {
...
function InitTableSecondarySales() {
    ...
    dataGrid = $("#gridContainer").dxDataGrid({
        ...
        onExporting: function (e) {
            ...
            var worksheet = workbook.addWorksheet('Secondary Sales Actual');
            DevExpress.excelExporter.exportDataGrid({
                ...
                workbook.xlsx.writeBuffer().then(function (buffer) {
                    saveAs(new Blob([buffer], { type: 'application/octet-stream' }), 'Export Secondary Sales Actual.xlsx');
                });
            });
            e.cancel = true;
        },
...
function openModalUpload(flag) {
    $('#inpFlag').val(flag);
    $('#titleModalUpload').text('Upload Secondary Sales');
